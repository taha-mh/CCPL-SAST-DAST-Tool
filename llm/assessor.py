...
from prompts.assessor_prompt import (
    ASSESSOR_RESPONSE_SCHEMA,
    ASSESSOR_SYSTEM_PROMPT,
    build_assessor_user_prompt,
)
...
def run_llm_assessor(
    ...
    for index, finding in enumerate(target_findings, start=1):
        ...
        assessment = query_llm(
            ASSESSOR_SYSTEM_PROMPT,
            user_prompt,
            response_schema=ASSESSOR_RESPONSE_SCHEMA,
            schema_name="security_assessment",
            model=model,
        )
