...
6. Return your verdict ONLY as a single valid JSON object. Start your output directly with '{' and end with '}'. Do NOT output any "Thinking Process:" block, chain-of-thought, or conversational preambles before or after the JSON.
